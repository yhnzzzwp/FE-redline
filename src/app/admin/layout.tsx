...
const NAV_ITEMS = [
  ...
  { key: 'promo', label: 'Promo', href: '/admin/promo', path: 'M3 12l8-8h8v8l-8 8-8-8zM15 9h.01' },
  { key: 'pegawai', label: 'Akun Pegawai', href: '/admin/pegawai', path: 'M3 5h18v14H3zM9 12a2 2 0 100-4 2 2 0 000 4z' },
      ...
      <div className="rl-main">
        <div className="rl-topbar">
          ...
          <div className="flex items-center gap-3 ml-auto">
            ...
            <div
              className={`hidden sm:flex items-center gap-1.5 px-2.5 py-1 rounded-lg border text-[11px] font-semibold ${
                isOnline
